...
struct VCOB1Widget : ModuleWidget {
    VCOB1Widget(VCOB1Module* module) {
        ...
        addOutput(createOutput<PJ301MPort>(Vec(x, sawY), module, VCOB1Module::SAW_OUTPUT));
        addOutput(createOutput<PJ301MPort>(Vec(x, sinY), module, VCOB1Module::SIN_OUTPUT));
        addOutput(createOutput<PJ301MPort>(Vec(x, paraY), module, VCOB1Module::PARA_OUTPUT));
